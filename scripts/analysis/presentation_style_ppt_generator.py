...
Converts presentation-style analysis into professional PowerPoint slides
"""
...
class PowerPointGenerator:
    def __init__(self):
        ...
        self.ppt_file = f"{self.output_dir}/synoptek_charge_assessment_presentation.pptx"
    ...
    def create_title_slide(self, prs, assessment):
    ...
    def create_executive_summary_slide(self, prs, assessment):
    ...
    def create_charge_breakdown_slide(self, prs, assessment):
        """Create charge breakdown slide."""
    ...
    def create_overpriced_services_slide(self, prs, assessment):
        """Create overpriced services slide."""
        slide_layout = prs.slide_layouts[1]
        slide = prs.slides.add_slide(slide_layout)
    ...
    def create_service_analysis_slide(self, prs, assessment):
        """Create service type analysis slide."""
        slide_layout = prs.slide_layouts[1]
        slide = prs.slides.add_slide(slide_layout)
    ...
    def create_findings_slide(self, prs, assessment):
        """Create findings and recommendations slide."""
        slide_layout = prs.slide_layouts[1]
        slide = prs.slides.add_slide(slide_layout)
    ...
    def create_strategic_recommendations_slide(self, prs, assessment):
    ...
    def create_conclusion_slide(self, prs, assessment):
    ...
    def create_powerpoint_presentation(self, assessment):
        ...
        # Create slides
        self.create_title_slide(prs, assessment)
        self.create_executive_summary_slide(prs, assessment)
        self.create_charge_breakdown_slide(prs, assessment)
        self.create_overpriced_services_slide(prs, assessment)
        self.create_service_analysis_slide(prs, assessment)
        self.create_findings_slide(prs, assessment)
        self.create_strategic_recommendations_slide(prs, assessment)
        self.create_conclusion_slide(prs, assessment)
    ...
    def generate_powerpoint_analysis(self):
        ...
        success = self.create_powerpoint_presentation(assessment)
...
def main():
    ...
    success = generator.generate_powerpoint_analysis()
